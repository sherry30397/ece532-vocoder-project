...
#
# Script generated by Vivado on Tue Mar 25 10:03:11 -0400 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mod_signal_analysis.sh
...
#
# Usage        : mod_signal_analysis.sh
#                mod_signal_analysis.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mod_signal_analysis.sh [-reset_run]
#                mod_signal_analysis.sh [-reset_log]
#                mod_signal_analysis.sh [-help]
#
...
# script info
echo -e "mod_signal_analysis.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mod_signal_analysis.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mod_signal_analysis xil_defaultlib.mod_signal_analysis xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mod_signal_analysis -key {Behavioral:sim_1:Functional:mod_signal_analysis} -tclbatch cmd.tcl -protoinst "protoinst_files/filterbank.protoinst" -protoinst "protoinst_files/mod_signal_analysis.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/filterbank.protoinst" -protoinst "protoinst_files/filterbank.protoinst" -protoinst "protoinst_files/mod_signal_analysis.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mod_signal_analysis.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mod_signal_analysis.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mod_signal_analysis.sh [-help]\n\
Usage: mod_signal_analysis.sh [-step]\n\
Usage: mod_signal_analysis.sh [-lib_map_path]\n\
Usage: mod_signal_analysis.sh [-reset_run]\n\
Usage: mod_signal_analysis.sh [-reset_log]\n\
Usage: mod_signal_analysis.sh [-keep_index]\n\
Usage: mod_signal_analysis.sh [-noclean_files]\n\n\
