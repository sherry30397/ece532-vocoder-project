...
#                script (type 'mod_signal_analysis.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mod_signal_analysis xil_defaultlib.glbl -o mod_signal_analysis_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mod_signal_analysis_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mod_signal_analysis_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mod_signal_analysis_simv.daidir vcs_lib c.obj)
